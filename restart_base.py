...
credential_path = "/home/pi/Desktop/complete_file/re/first-henu-tvclhj-7ebb92ce3259.json"
    ...
    while True:
        ...
        for response in responses:
            ...
            if "노래 틀어 줘" in response.recognition_result.transcript:
                mixer.init()
                mixer.music.load('/home/pi/Desktop/complete_file/voice_folder/good_morning.mp3') #제 이름을 불러주세요 
                mixer.music.play()
                return "노래 끝났습니다."
